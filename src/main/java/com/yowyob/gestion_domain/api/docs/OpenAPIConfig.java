package com.yowyob.gestion_domain.api.docs;
...
public class OpenAPIConfig {
  ...
  public OpenAPI myOpenAPI() {
    ...
    Info info = new Info()
        .title("API de gestion des domaines ")
        .version("1.0")
        .contact(contact)
        .description("Cet API est un endpoint pour la gestion des domains d'utilisation de cette abstraction.").termsOfService("http://localhost:4000/ressources")
        .license(mitLicense);
